    ...
    <div>
      ...
      {/* <div className="">
        ...
        <p className="mt-4 text-base leading-relaxed text-gray-600">
          ...
          기초로 수업을 진행하며, 회원님의 체형과 강점을 고려하여 이론을 통해
          설명하고, 스스로 신체의 조화로운 움직임을 만들어낼 수 있게끔 지도하는
          방식으로 수업이 진행됩니다.
        </p>
        <p className="mt-4 text-base leading-relaxed text-gray-600">
          가장 추천드리는 방식은 오프라인에서 직접적으로 자세에 대한 레슨을
          받고, 이후 온라인 코칭과 병행하여 개인의 운동환경에 맞춘 개인화 주간
          프로그램을 제공받으며 스스로 운동을 해나가며 관리를 받는것이 가장 좋은
          방법입니다.
        </p>
      </div> */}
