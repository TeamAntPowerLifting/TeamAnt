                ...
                <div className="flex flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row">
                  ...
                  <div className="relative flex self-center flex-1 p-8 ml-0 bg-white border rounded shadow lg:items-center lg:-ml-12">
                    <div>
                      ...
                      <p className="text-sm leading-7 text-gray-400">단순히
                ...
                <div className="flex flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row ">
                  ...
                  <div className="relative self-center flex-1 p-8 ml-0 bg-white border rounded shadow lg:items-center lg:-ml-12">
                    ...
                    <p className="text-sm leading-7 text-gray-400">
                      이러한 부분에서 우리는 선수로서의 증명, 회원으로서의 증명, 체육관련 전공(선수트레이닝 석사과정, 체육학과, 물리치료학과)으로 폭넓은 경험과 지식을 보유하고 있다고 할 수 있습니다.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row ">
                ...
                <div className="flex flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row ">
                  ...
                  <div className="relative self-center flex-1 p-8 ml-0 bg-white border rounded shadow lg:items-center lg:-ml-12">
                    ...
                    <p className="text-sm leading-7 text-gray-400 mb-2">
                      ...
                      팀이고, 우리가 목표하는 바이기도 합니다. </p>
                    <p className="text-sm leading-7 text-gray-400">또한 팀으로써
                      ...
                      레퍼런스가 되어 더욱 발전하는 코칭팀을 만들어낼 것 입니다.
                    </p>
                  </div>
                </div>
              </div>
