            ...
            <div className="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
              ...
              <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
                ...
                <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                  ...
                  <p className="mt-5 text-lg text-gray-700 text md:text-left">
                    ...
                    아니라, 국제 경기에서도 기록을 세우고 입상을 해내는, 한국의
                    파워리프팅의 역사를 써내고 있으며, 한국을 알리고 있기도
                    하죠.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
                ...
                <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                  ...
                  <p className="mt-5 text-lg text-gray-700 text md:text-left">
                    우리는 코칭은 수직적인 관계로 이루어지는 것이 아니라는 점을
                    강조하고 있습니다. 그러한 만큼, 수평적인 관계에서
              ...
              <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
                ...
                <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
                  ...
                  <p className="mt-5 text-lg text-gray-700 text md:text-left">
                    기본적으로 코칭은 1:1로 진행이 되지만, 세미나 진행 혹은 시합
                    현장에서의 서포팅과 같은 다양한 곳에서 담당 코치 이외의
                    코치에게도 도움을 받을 수 있습니다. 한 명의 코치와 함께 하게
                    되었다고 해서, 그 한명에게만 모든 것이 한정되는 것이
                    아닙니다. 모든 코치들에게 도움을 받을 수 있죠. 그것이
                    팀이고, 우리가 목표하는 바이기도 합니다. 또한 팀으로써
                    활동을 한다는 것은, 그만큼 더 많은 레퍼런스가 쌓인다는 뜻이
                    됩니다. 정보가 많을수록, 더 많은 수를 볼 수 있겠죠. 코치들은
                    많은 경험과 이론적 근거를 통해 프로그램과 방향성을 제시하고,
                    시합에 참여하는 경우 여러 코치들이 힘을 합쳐 여러분이 최고의
                    기량을 낼 수 있도록 도와드릴 겁니다. 또한, 여러분이
                    보여주시는 결과물들은 또다시 우리의 소중한 레퍼런스가 되어
                    더욱 발전하는 코칭팀을 만들어낼 것이구요.
                  </p>
                </div>
              </div>
            </div>
