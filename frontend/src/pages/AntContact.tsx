  ...
  return (
    <>
      ...
      <section className='bg-white  pt-16 '>
        ...
        <form onSubmit={sendEmail} className=" w-full md:w-2/3 mx-auto mt-10 my-7">
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 text-lg" v-for="grid-first-name">
                이름
              </label>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 text-lg" v-for="grid-password">
                이메일
              </label>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <select defaultValue='DEFAULT' name='category' id='category' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full leading-tight py-3 px-4 mb-3">
          ...
          <div className="md:flex md:items-center">
            <div className="md:w-1/3">
              <button type="submit" value="Send" className="shadow bg-gray-300 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" >
                전송하기
              </button>
            </div>
          </div>
      ...
      <div className='shadow-md w-full md:w-2/3 mx-auto mt-4'>
        ...
        <div id="FAQ_1" className='overflow-hidden border-t'>
          <label>
            ...
            <div className='bg-gray-300 max-h-0 peer-checked:max-h-screen'>
              <p className='p-5 xs:p-10'>Contact 란에서 온라인코칭 신청 카테고리를 선택 후 신청을 해주시면 이메일을 통해 설문지를 제공해 드립니다.
        ...
        <div id="FAQ_2" className='overflow-hidden border-t'>
          <label>
            ...
            <div className='bg-gray-300 max-h-0 peer-checked:max-h-screen'>
              <p className='p-5 xs:p-10'>오프라인의 경우 코치님들마다 활동하는 지역과 체육관이 모두 다르기 때문에,
        ...
        <div id="FAQ_4" className='overflow-hidden border-t'>
          <label>
            ...
            <div className='bg-gray-300 max-h-0 peer-checked:max-h-screen'>
              <p className='p-5 xs:p-10'>희망하시는 코치님이 있으시다면 해당 코치님께 연결해 드리지만,
