        ...
        <form onSubmit={sendEmail} className=" w-full md:w-2/3 mx-auto mt-10 my-7">
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              <label className=" text-lg block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" v-for="grid-first-name">
                이름
              </label>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              <label className="text-lg block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" v-for="grid-password">
                이메일
              </label>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              <label className="text-lg block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 text-lg" v-for="grid-password">
                질문 유형
              </label>
