  ...
  return (
    <div className="flex flex-col h-screen ">
      ...
      <div className="flex-1 mt-28 pb-28 ">
        <div>
          <img
            className="mt-1 object-fill w-full sm:h-[100%] h-44  md:object-left md:scale-100 md:origin-top-left z-10 "
            src={main}
            alt=""
          />
        </div>
        <section className="py-10 sm:py-20">
          <div className="">
            <img
              className="object-fill mx-auto rounded-lg sm:h-[100%] h-44  lg:w-2/3 w-[100%]"
              src={main1}
              alt=""
            />
          </div>
